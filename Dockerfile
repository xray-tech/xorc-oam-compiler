...
RUN opam repository add remote https://opam.ocaml.org && opam update && opam install -y dune menhir core async async_extended msgpck "sedlex<2.0" ppx_jane benchmark yojson mtime ppx_tools_versioned.5.2
